import styles from "./MoveEvacuationAreaUpButton.module.css";
...
export default function MoveEvacuationAreaUpButton() {
  ...
  return (
    <ActionButton className={styles.actionButton} ariaLabel="move evacuation area up" onClick={handleMoveUp}>
      <FontAwesome icon="faCaretUp" fontSize={20} color="white" />
    </ActionButton>
  );
}
